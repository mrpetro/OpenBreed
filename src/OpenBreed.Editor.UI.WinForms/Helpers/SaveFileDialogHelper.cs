...
namespace OpenBreed.Editor.UI.WinForms.Helpers
{
    ...
    {
        public static void PrepareToSaveABEdProjFile(SaveFileDialog saveFileDialog)
        {
            saveFileDialog.Title = "Input ABEd Project File to Save...";
            saveFileDialog.Filter = "Alien Breed Map Files (*.ABEdProj)|*.ABEdProj|All Files (*.*)|*.*";
        }
