...
{
    public class OnInitTurretLazerProjectileSystem : IEventSystem<EntityEnteredEvent>
    {
        ...
        public OnInitTurretLazerProjectileSystem(IGameServices services, IWeaponMan weaponMan)
        {
        ...
        public void OnEvent(
            ...
            [EntityTriggerActionFilter("EnterWorld", "TurretLazerProjectileInit")]
            EntityEnteredEvent e, IWorld world)
        {
            ...
            FormattableString animName = $"Vanilla/L1/Projectile/TurretLazer/{degree:0.0}";
