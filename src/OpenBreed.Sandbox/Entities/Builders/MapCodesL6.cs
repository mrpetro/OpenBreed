...
namespace OpenBreed.Sandbox.Entities.Builders
{
    public static class MapCodesL6
    {
        ...
        public const int GFX_KEYCARD_BLUE_F1 = 649;
        public const int GFX_KEYCARD_RED_F1 = 651;
        public const int GFX_KEYCARD_GREEN_F1 = 647;
        ...
        public static void SetupL6(this MapMapper mapper)
        {
            ...
            mapper.Register("KeycardRed", GFX_KEYCARD_RED_F1,  "F2");
            mapper.Register("KeycardGreen", GFX_KEYCARD_GREEN_F1,  "F2");
            mapper.Register("KeycardBlue", GFX_KEYCARD_BLUE_F1,  "F2");
