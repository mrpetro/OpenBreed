...
{
    public static class MapCodesL8
    {
        //GFX codes
        public const int GFX_MEDKIT_SMALL_F1 = 564;
        public const int GFX_MEDKIT_SMALL_F2 = 570;
        public const int GFX_MEDKIT_SMALL_F3 = 576;
        ...
        public const int GFX_KEYCARD_BLUE_F1 = 534;
        public const int GFX_KEYCARD_RED_F1 = 554;
        public const int GFX_KEYCARD_GREEN_F1 = 594;


        public static void SetupL8(this MapMapper mapper)
        {
            ...
            mapper.Register("Keycard", GFX_KEYCARD_RED_F1, "Keycard/Red/F1");
            mapper.Register("Keycard", GFX_KEYCARD_GREEN_F1, "Keycard/Green/F1");
            mapper.Register("Keycard", GFX_KEYCARD_BLUE_F1, "Keycard/Blue/F1");
