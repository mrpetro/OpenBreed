...
{
    public static class MapCodesL5
    {
        //GFX codes
        public const int GFX_MEDKIT_SMALL_F1 = 640;
        public const int GFX_MEDKIT_SMALL_F2 = 420;
        public const int GFX_MEDKIT_SMALL_F3 = 400;
        ...
        public const int GFX_KEYCARD_BLUE_F2 = 618;
        public const int GFX_KEYCARD_RED_F2 = 638;
        public const int GFX_KEYCARD_GREEN_F2 = 598;


        public static void SetupL5(this MapMapper mapper)
        {
