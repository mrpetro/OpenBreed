    ...
    public static class WorldManExtensions
    {
        ...
        public static IWorld CreateGameWorld(this IWorldMan worldMan, string name)
        {
            return worldMan.Create()
                ...
                .AddSystem<MapExitingSystem>()
                .AddSystem<TeleportingSystem>()
                .AddSystem<ItemPickupSystem>()
                .AddSystem<SmartCardReadingSystem>()
                .AddSystem<LandMineDetonationSystem>()
                .AddSystem<ExplosionOnEnterWorldSystem>()
                .AddSystem<TurretSystem>()
                .AddSystem<ActorDeathSystem>()
                .AddSystem<ActorMovementSystem>()
