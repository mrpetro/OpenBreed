...
namespace OpenBreed.Editor.UI.WinForms.Helpers
{
    public class OpenFileDialogHelper
    {
        ...
        public static void PrepareToOpenABDatabase(System.Windows.Forms.OpenFileDialog openFileDialog)
        {
            openFileDialog.Title = "Select ABEd Project File to Open...";
            openFileDialog.Filter = "Alien Breed Database file (*.xml)|*.xml|All Files (*.*)|*.*";
        }

        public static void PrepareToOpenABEdProjFile(System.Windows.Forms.OpenFileDialog openFileDialog, string initialDirectory = null)
        {
            openFileDialog.Title = "Select ABEd Project File to Open...";
        ...
        public static void PrepareToOpenMAPFile(System.Windows.Forms.OpenFileDialog openFileDialog)
        {
            openFileDialog.Title = "Select Alien Breed Map File to Open...";
            openFileDialog.Filter = "Alien Breed Map Files (MAP.*)|MAP.*|All Files (*.*)|*.*";
        }

        public static void PrepareToOpenBLKFile(System.Windows.Forms.OpenFileDialog openFileDialog)
        {
            openFileDialog.Title = "Select Alien Breed Tile File to Open...";
            openFileDialog.Filter = "Alien Breed Tile File (*.BLK)|*.BLK|All Files (*.*)|*.*";
        }

        public static void PrepareToOpenSPRFile(System.Windows.Forms.OpenFileDialog openFileDialog)
        {
        ...
        public static void PrepareToOpenEPFArchive(System.Windows.Forms.OpenFileDialog openFileDialog)
        {
